...
public class Sign {
    ...
    public static byte[] SignData(String rawData) {
        ...
        sb.append(rawData);
        String rsaPublic = new String(Base64.decode(RSA_PUBLIC_MASTER, Base64.NO_WRAP));
